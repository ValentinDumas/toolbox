...
- **À réviser (N)** : items non encore validés — édition directe dans le navigateur (9 champs : type, montants HT/TVA/TTC, date, émetteur, n° facture, catégorie, notes). Le titre de chaque carte (émetteur + date) est cliquable et ouvre la prévisualisation PDF inline. Onglet grisé et non cliquable si aucun item
