...
| `validé` | Extraction ≥ 80 % ou action manuelle | Certifié fiscalement — corrections tracées |

- `à_réviser` → formulaire inline dans l'onglet "À réviser" (`révisé_par = 'user'` après validation)
