...
**Plans**: 3 plans (2 waves)
  - [x] 09-01-PLAN.md — QUA-01 : exécuter les scénarios liasse automatisables (Playwright) + corriger les écarts bloquants
  - [x] 09-02-PLAN.md — QUA-02 : réconcilier g1/g4/g8 + 02/03/04-UAT (re-test live + file:line)
  - [x] 09-03-PLAN.md — QUA-01/QUA-02 : confirmation humaine PDF/CSV + rapport Phase 9 consolidé
