...
Fonctionnalité: Répartition des frais d'acquisition au prorata (D-FIS-G1.3, BOFIP-BIC-AMT-10-20 §110)
  ...
  Scénario: Exemple G1.3 — répartition prorata 5 amortissables, frais 24 000 € (D-FIS-G1.3)
    ...
    Et le composant gros_oeuvre reçoit la plus grande quote-part proportionnelle à son montant
    Et la somme des quotes-parts est exactement egale aux frais totaux
    Et le dernier composant selon l'ordre stable absorbe l'eventuel centime d'arrondi
  ...
  Scénario: Un seul composant amortissable reçoit l'intégralité des frais
    ...
    Quand j'active la fiscalité réelle sur ce bien
    Alors le composant gros_oeuvre reçoit l'intégralité des frais d'acquisition
    Et le montant total du composant gros_oeuvre inclut les frais
