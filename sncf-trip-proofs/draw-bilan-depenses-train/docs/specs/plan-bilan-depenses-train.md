...
```
justificatif-achat-yyyymmdd-pp-PPttc-xxxxxxxxxx-yyyymmdd.pdf
```
Exemple : `justificatif-achat-20260330-18-50ttc-2668453920-20260330.pdf`

**Justificatif de voyage** (`curate-justificatifs-voyage.py`) :
```
justificatif-voyage-yyyymmdd-pp-PPttc-REF[-TCN][-N].pdf
```
Exemple : `justificatif-voyage-20260402-18-50ttc-ne3erm-016487606.pdf`
...
|------------|-----------|----------------|
| 16/03/2026 |   10,00 € | justificatif-achat-20260316-10-00ttc-….pdf |
| …          |           |                |
```
...
| Fichier                          | Raison                        |
|----------------------------------|-------------------------------|
| justificatif-achat-20260401-...  | Montant non parseable         |
...
**Achat** :
```
justificatif-achat-(\d{8}(?:-\d{8})?)-(\d{1,4}-\d{2})ttc-(.+)\.pdf
...
**Voyage** :
```
justificatif-voyage-(\d{8})-(\d{1,4}-\d{2})ttc-([A-Z0-9]+(?:-\d{6,12})?)(?:-\d{1,3})?\.pdf
...
- Champ montant non parseable (ex : `prix-inconnu` dans le nom)
...
19 fichier(s) PDF trouvé(s)
  ...
  [DOUBLON] justificatif-achat-20260327-…-20260504.pdf → même commande que …-20260330.pdf
...
── Détail des trajets ──────────────────────────────
  ...
  16/03/2026  (2 trajet(s) — 25,60 €)
    • [calc] 10,00 €  ←  justificatif-achat-20260316-10-00ttc-….pdf
    • [calc] 15,60 €  ←  justificatif-achat-20260316-15-60ttc-….pdf

  23/04/2026  (2 trajet(s) — 28,50 €)
    • [PDF ] 10,00 €  ←  justificatif-achat-20260423-20260424-57-00ttc-….pdf
    • [PDF ] 18,50 €  ←  justificatif-achat-20260423-20260424-57-00ttc-….pdf
  …
...
- [x] Support justificatifs de voyage (2026-05-04) :
  - `RE_RENAMED_VOYAGE` : `justificatif-voyage-yyyymmdd-amount-REF[-TCN][-N].pdf`
