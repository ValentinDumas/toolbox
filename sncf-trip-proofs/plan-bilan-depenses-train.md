...
Le script source le dossier IN (typiquement `justificatif-achat/output/` ou `justificatif-voyage/inbox/`) et génère un fichier `bilan-depenses-train-YYYY.md` dans OUT.
...
### Voyages par mois (NOUVEAU — détail par jour)
```
...
- [x] Testé sur 19 justificatifs d'achat réels (`justificatif-achat/output/`)
